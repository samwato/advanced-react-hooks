...
useReducer use cases is... i want the state changing logic to be all in the one place and not where the state change happens, which could be in a random child component.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=01%3A%20useReducer%3A%20simple%20Counter&em=sambenwatson%40gmail.com).
